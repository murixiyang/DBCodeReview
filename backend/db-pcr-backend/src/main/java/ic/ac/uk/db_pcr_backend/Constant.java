...
public class Constant {
    public static final String GERRIT_BASE_URL = "http://gerrit:8080";
    public static final String GERRIT_AUTHENTICATE_URL = "http://gerrit:8080/a";
    ...
    public static final String GITLAB_API_BASE_URL = "http://gitlab/api/v4";
